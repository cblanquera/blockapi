...
var BitPay = function (_UtxoInterface) {
    _inherits(BitPay, _UtxoInterface);

    function BitPay() {
        _classCallCheck(this, BitPay);

        var _this = _possibleConstructorReturn(this, (BitPay.__proto__ || Object.getPrototypeOf(BitPay)).call(this));

        _this.settings = _API2.default.config('services', 'bitpay');
        return _this;
    }
